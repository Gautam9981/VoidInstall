...
def check_network_connection():
    ...
    Uses multiple fallback methods since ping might not be available
    """
    import socket
    ...
    # Method 3: Try ping if available (fallback)
    try:
    ...
    # Method 4: Check if we have any network interfaces up
    try:
